...
class LSTMList(nn.Module):

    def __init__(self, args):
        super(LSTMList, self).__init__()
        self.args = args
...
class LSTMList_model(nn.Module):

    def __init__(self, args):
        super(LSTMList_model, self).__init__()
        self.args = args
        self.hidden_dim = args.lstm_hidden_dim
        self.num_layers = args.lstm_num_layers
        V = args.embed_num
        ...
        self.highway = nn.ModuleList([LSTMList(args) for _ in range(args.layer_num_highway)])
